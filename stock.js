...
async function handleSetPrice(e) {
    ...
    if (isNaN(sellingPrice) || sellingPrice <= 0) { // CHANGED FROM sellingPrice < 0 TO sellingPrice <= 0
    ...
    try {
        ...
        showMessage('Failed to set price: ' + error.message, 'error'); // ADDED ERROR MESSAGE
    }
}
