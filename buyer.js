...
import { finalizePurchase } from './stock.js';
// Initialize Firebase
...
async function placeOrder() {
    ...
    try {
        ...
        // ✅ UPDATE BUYER STOCK (MERGE BY productId + ownerId)
for (const item of cart) {
    await finalizePurchase({
        ownerId: currentUser.uid,          // buyer becomes stock owner
        ...
        isResource: userRole === 'manufacturer' // manufacturer buys resources
    });
}
