...
function addToRecentSellers(seller) {
    ...
    recentSellers.unshift({
        ...
        role: seller.role,
        businessAddress: seller.businessAddress, // Added address storage
        businessPhone: seller.businessPhone      // Added phone storage
    });
...
// Place order - UPDATED to include Seller Details
async function placeOrder() {
    ...
    try {
        ...
        // FIX: Added explicit Seller Details to prevent "undefined" in Order Views
        const orderData = {
            ...
            sellerTIN: selectedSeller.businessTIN || 'N/A',           // Added
            sellerAddress: selectedSeller.businessAddress || 'N/A',   // Added
            sellerPhone: selectedSeller.businessPhone || 'N/A',       // Added
