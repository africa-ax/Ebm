...
// Approve order with inventory transfer
window.approveOrder = async function(orderId) {
    ...
    try {
        ...
        // Step 2: Validate and deduct stock from seller
        for (const item of order.items) {
            if (userRole === 'manufacturer') {
                ...
                // Get full product details for transfer
                ...
                if (productDoc.exists) {
                    item.productDetails = productDoc.data();
                }
            }
        }
