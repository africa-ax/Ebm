...
// View Invoice - UPDATED to show VAT Type and handle missing data
                ...
                <div class="detail-section">
                    ...
                    <table class="items-table">
                        <thead>
                            <tr>
                                <th>Product Name</th>
                                <th>VAT Type</th> <th>Unit Price (RWF)</th>
                                <th>Quantity</th>
                                <th style="text-align: right;">Total (RWF)</th>
                            </tr>
                        </thead>
                        <tbody>
                            ${invoice.items?.map(item => `
                                <tr>
                                    ...
                                    <td>${item.vatType || '-'}</td> <td>${formatCurrency(item.unitPrice)} RWF</td>
                                    <td>${item.quantity}</td>
...
// Print Invoice - UPDATED to show VAT Type
...
window.approveOrder = async function(orderId) {
    ...
    try {
        ...
        // FIX: Robust check for Seller Data to prevent "undefined"
        const invoiceData = {
