...
async function handleEditProductSubmit(e) {
    ...
    try {
        ...
        // Note: For a real app, you might also want to update the public_products entry here if names/vat change.
        // But per instructions to keep things simple and matching existing flow, we just update local.
