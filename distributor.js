...
// Initialize Firebase - Same way as manufacturer.js
    ...
    try {
        ...
        if (userDoc.exists) {
            ...
            if (userData.role !== 'distributor') {
                alert('Access denied. This page is for distributors only.');
                auth.signOut();
                return;
            }
            
            // Display business name
            document.getElementById('user-business-name').textContent = userData.businessName || 'Distributor';
        }
    } catch (error) {
